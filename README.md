...
|------|-------|---------|-----------|--------|--------|
| [`tests/jq.test`](https://github.com/jqlang/jq/blob/master/tests/jq.test) (regression suite) | 521 | 280 | 241 | **241 (100.0%)** | 0 |
| [`tests/man.test`](https://github.com/jqlang/jq/blob/master/tests/man.test) (manual examples) | 230 | 91 | 139 | **139 (100.0%)** | 0 |
| **Combined** | **751** | **371** | **380** | **380 (100.0%)** | **0** |
...
**Not yet implemented:** `path`, `getpath`, `setpath`, `delpaths`, `reduce`, `foreach`, `label-break`, user-defined functions (`def`), `hypot(x;y)`, `fma(x;y;z)`.
