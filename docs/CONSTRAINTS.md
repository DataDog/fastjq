...
| **Tier 3** | Deferred — requires executor redesign, not a policy decision | full decimal semantics / module-import helpers |
...
|-----------|-------------|
| full `have_decnum` semantics, module/import helpers | These remaining parity gaps are broader semantic/runtime integrations rather than small isolated builtins. They are deferred on this branch in favor of the higher-yield library surface that already parses and executes without module loading. |
